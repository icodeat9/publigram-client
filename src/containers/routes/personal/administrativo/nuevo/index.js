...
import FormBasicInfo from './FormBasicInfo.js'
...
class Window extends Component {
    ...
    handleformData = (event, type) => {
        ...
        form[type] = (type == "supervisorId" || type == "nationalityId" || type == "genderId") ? event : event.target.value;
        console.log(event)
        this.setState({ form })
    }
                        ...
                        tabs={[
                            {
                                ...
                                tabContent: (
                                    // {/* Datos de la persona */}
                                    <FormBasicInfo loading={loading} errors={errors} sendData={this.sendData} classes={classes} handleformData={this.handleformData} handleDates={this.handleDates}
                                        form={form} />
                                )
                            },
                            {
                                ...
                                tabIcon: WorkOutline,
                                tabContent: (
                                    <FormJobInfo loading={loading} errors={errors} sendData={this.sendData} classes={classes} handleformData={this.handleformData} handleDates={this.handleDates}
                                        form={form} />
                                )
                            },
                            {
                                tabButton: "Contacts",
                                tabIcon: AccountCircleOutlined,
                                tabContent: (
                                    <FormContacts actual_id={1005} data_contacts={data_contacts} contact_types={contact_types} actual_contact={actual_contact} form={form_contacts} newForm={this.newForm} handleFormContacts={this.handleFormContacts} saveData={this.sendData} />
                                )
                            },
                            {
                                tabButton: "Documents",
                                tabIcon: FolderSharedOutlined,
                                tabContent: (
                                    <Typography variant="display1">Working in</Typography>
                                )
                            },
                            {
                                tabButton: "Trainings",
                                tabIcon: AttachFileOutlined,
                                tabContent: (
                                    <Typography variant="display1">Working in</Typography>
                                )
                            },
