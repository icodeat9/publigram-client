    ...
    return <Slide in>
        <FormControl className={classes.mainFormControl} >
            ...
            <TextField select required error={errors.contenido} value={form.contenido} className={[classes.textField]} onChange={(e) => handleformData(e, "contenido")}>
                        <MenuItem value={0} disabled >Tipo de empresa</MenuItem>
                        {["Negocios", "Comida"].map((v, i) => <MenuItem value={v}>{v}</MenuItem>)}
            </TextField>
            <FormGroup row>
    ...
    render() {
        ...
        return (
            ...
            <div style={{ overflowX: "hidden" }} >
                <Typography variant="display1">Empresa o emprendedor</Typography>
